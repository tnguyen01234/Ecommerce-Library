...
// Async was added to uncover a promise in getBooks
async function renderBooks(filter) {
  ...
  if (filter === 'LOW_TO_HIGH') {
    const filteredBooks = books.sort((a, b) => (a.salePrice || a.originalPrice) - (b.salePrice || b.originalPrice));
                                              ...
                                              // the all operator ||, Uses the salesprice first, if not || uses original price
...
// FAKE DATA , Add the fake adata into the a promise with a timeout to cause a delay affect.
function getBooks() {
